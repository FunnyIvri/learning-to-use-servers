...
class Textcreator:
    def __init__(self, text: str, size: int, pos: (int, int), display_surface: pygame.display, color=(255, 255, 255), font = "freesanbold.ttf"):
        self.text = str(text)
        self.size = size
        self.pos = pos
    ...
    def createText(self):
        ...
        textRect1.x = self.pos[0]
        textRect1.y = self.pos[1]
